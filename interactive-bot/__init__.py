...
llm_model = os.getenv("LLM_MODEL", "hermes")

# ═══ 风控配置 ═══
_blacklist_raw = os.getenv("BLACKLIST_USER_IDS", "")
blacklist_user_ids = [int(x.strip()) for x in _blacklist_raw.split(",") if x.strip()]
